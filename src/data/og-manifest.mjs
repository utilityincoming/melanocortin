...
export const ogPages = [
  ...
  { slug: 'structures', eyebrow: 'STRUCTURE · CRYO-EM', title: 'What the receptors look like' },
  ...
  { slug: 'melanocortin-agonists', eyebrow: 'THERAPEUTICS · HUB', title: 'Melanocortin agonists' },
