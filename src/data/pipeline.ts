...
export const pipeline: PipelineEntry[] = [
  ...
  },
  {
    ...
    stage: 3,
    status: 'active',
    note: 'MELODY-1 Phase 3 hit its co-primary symptom endpoint but missed the co-primary sign endpoint (conjunctival staining); remaining MELODY trials ongoing',
    href: '/pl-9643',
  },
  {
    name: 'PL-8177',
  ...
  {
    name: 'Bivamelagon (LB54640)',
    target: 'Oral MC4R agonist',
    indication: 'Acquired hypothalamic & genetic obesity',
    sponsor: 'Rhythm',
    stage: 2,
    status: 'active',
    note: 'Oral small-molecule alternative to setmelanotide; Phase 2 SIGNAL cut BMI 9.3% at the top dose (2025); pivotal Phase 3 in acquired hypothalamic obesity planned for 2026',
    href: '/bivamelagon',
  },
  {
    name: 'RM-718',
    target: 'MC4R agonist (MC1R-sparing)',
    indication: 'Acquired hypothalamic obesity',
    sponsor: 'Rhythm',
    stage: 1,
    status: 'active',
    note: 'Once-weekly and engineered to spare MC1R — designed to deliver the appetite effect without the hyperpigmentation of earlier agonists',
    href: '/bivamelagon',
  },
  {
