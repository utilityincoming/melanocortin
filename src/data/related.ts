...
export const PAGES: Record<string, PageMeta> = {
  ...
  'mc1r-selectivity': {
    ...
    title: 'Why there’s no clean tanning drug',
    blurb: 'Potent melanocortin drugs that build pigment exist — but none that hit MC1R alone. Why a selective MC1R agonist is so hard to make.',
  },
  effects: {
    href: '/effects',
...
export const RELATED: Record<string, string[]> = {
  ...
  'binding-matrix': ['explorer', 'receptors', 'alpha-msh', 'afamelanotide', 'melanocortin-agonists', 'structures', 'mc1r-selectivity'],
  'mc1r-selectivity': ['melanocortin-agonists', 'binding-matrix', 'receptors/mc1r', 'melanotan', 'afamelanotide', 'structures'],
  structures: ['receptors', 'receptors/mc4r', 'binding-matrix', 'alpha-msh', 'receptors/mc1r', 'agrp'],
  'receptors/mc1r': ['afamelanotide', 'mc1r-pain', 'alpha-msh', 'asip', 'genetics', 'fearfully-and-wonderfully-made', 'mc1r-selectivity'],
  ...
  afamelanotide: ['receptors/mc1r', 'dersimelagon', 'melanotan', 'alpha-msh', 'binding-matrix', 'mc1r-selectivity'],
  ...
  melanotan: ['pt-141-vs-melanotan', 'bremelanotide', 'afamelanotide', 'shu9119', 'receptors/mc1r', 'mc1r-selectivity'],
