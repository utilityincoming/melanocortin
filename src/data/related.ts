...
export const RELATED: Record<string, string[]> = {
  ...
  'receptors/mc4r': ['setmelanotide', 'bivamelagon', 'agrp', 'shu9119', 'glp1-appetite', 'alpha-msh'],
  ...
  therapeutics: ['setmelanotide', 'afamelanotide', 'bremelanotide', 'inflammation', 'pipeline'],
};
